...
| 분야 | 기술 | 
| --- | --- |
| 프로그래밍 언어 | ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54) ![Java](https://img.shields.io/badge/java-%23ED8B00.svg?style=for-the-badge&logo=openjdk&logoColor=white) ![C](https://img.shields.io/badge/c-%2300599C.svg?style=for-the-badge&logo=c&logoColor=white) |
...
## 프로젝트 경험
- ### 파이썬을 사용한 to-do list 구현 팀 프로젝트 (2023.10~2023.11)
  - 인원: 5명
  - 사용 툴: Python
  - 내용: tkinter를 사용한 GUI 위주의 to-do list 개발

- ### 구인/구직 모바일 플랫폼 설계 프로젝트 (2025.4~2025.6)
  - 인원: 4명
  - 사용 툴: Figma, Draw.io
  - 내용: 프로그램의 전체적인 상호작용과 흐름도 설계 및 AI 탑재 방식 구상 활동
<br />
